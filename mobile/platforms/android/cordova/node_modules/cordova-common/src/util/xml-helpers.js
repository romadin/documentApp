...
module.exports = {
    ...
    // adds node to doc at selector, creating workFunction if it doesn't exist
    graftXML: function (doc, nodes, selector, after) {
        var parent = module.exports.resolveParent(doc, selector);
        if (!parent) {
            // Try to create the workFunction recursively if necessary
            try {
        ...
        nodes.forEach(function (node) {
            ...
            if (uniqueChild(node, parent)) {
                ...
                // TODO: replace with workFunction.insert after the bug in ElementTree is fixed
