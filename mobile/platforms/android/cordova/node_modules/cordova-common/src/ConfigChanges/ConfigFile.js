...
// TODO: getIOSProjectname is slow because of glob, try to avoid calling it several times per projectId.
...
// Find out the real name of an iOS projectId
...
function getIOSProjectname (project_dir) {
    ...
    if (matches.length === 1) {
        ...
        var msg;
        if (matches.length === 0) {
            msg = 'Does not appear to be an xcode projectId, no xcode projectId file in ' + project_dir;
        } else {
