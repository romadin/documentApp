...
// Execute func passing it the workFunction array and the xmlChild key.
// When createParents is true, add the file and workFunction itemsContainer  they are missing
// When createParents is false, stop and return undefined if the file and/or workFunction itemsContainer are missing
...
exports.process_munge = function process_munge (obj, createParents, func, keys /* or key1, key2 .... */) {
    ...
    if (keys.length === 1) {
        ...
        throw new Error('Invalid key format. Must contain at most 3 elements (file, workFunction, xmlChild).');
    }
};
