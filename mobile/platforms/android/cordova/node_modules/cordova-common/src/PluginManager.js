 ...
 * @param {IDEProject} ideProject The IDE projectId to add/remove plugin changes to/from
 */
 ...
 *    needed for platform IDE projectId must be passed from outside. Plugin variables (which
 ...
 *  * Save the IDE projectId, so the changes made by installers are persisted.
